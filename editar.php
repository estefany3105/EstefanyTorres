    ...
    <div class="row">
      <div class="col-md-12">
        <div class="alert alert-success" role="alert">
          El registro del producto ha sido actualizado correctamente
        </div>
      </div>
    </div>
  </div>
...
if (isset($productos) && $productos) {
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="mt-4">Editando el registro del producto <?= escapar($productos['producto']) . ' ' . escapar($productos['categoria'])  ?></h2>
        <hr>
        <form method="post">
